...
then
   ...
   if [[ $ACCESS_REPOSITORY_VIA_SSL == true && -f '/srv/alfresco/config/alfresco/web-extension/alfresco-system.p12' && -f '/srv/alfresco/config/alfresco/web-extension/ssl-truststore' ]]
   then
